...
import { StyleSheet, Text, View, Image, ImageBackground, Pressable, Linking, Alert, ScrollView } from 'react-native';
        ...
        <ImageBackground source={require('../assets/Post_image.png')} style={{ width: '100%', height: '100%' }}>
            <ScrollView contentContainerStyle={styles.container}>
                <View style={styles.column}>
                    ...
                    <Image source={require('../assets/festival.png')} style={{ marginTop: '10%', width: 178, borderRadius: 20 }} />
